...
if (!verifyOnly) {
  const unsigned = Object.freeze({ schema: "HAIOS_B6_PROJECT_EXPANSION_FINAL_CERTIFICATION_R1", terminal: finalTerminal,
    ...
    stageOneCertificationPath: stageOnePath, stageOneCertificationFileSha256: sha(stageOneBytes), stageOneSealPath, stageOneSealSha256: sha(stageOneSealBytes),
    stageTwoCertificationPath: stageTwoPath, stageTwoCertificationFileSha256: sha(stageTwoBytes), stageTwoSealPath, stageTwoSealSha256: sha(stageTwoSealBytes),
  ...
  const sealUnsigned = Object.freeze({ schema: "HAIOS_B6_PROJECT_EXPANSION_FINAL_SEAL_R1", terminal: finalTerminal,
    finalCertificationSha256: sha(finalBytes), stageOneCertificationSha256: sha(stageOneBytes), stageOneSealSha256: sha(stageOneSealBytes),
    stageTwoCertificationSha256: sha(stageTwoBytes), stageTwoSealSha256: sha(stageTwoSealBytes), sha256SumsSha256: sha(sumsBytes),
  ...
  if (seal.terminal !== finalTerminal || seal.finalCertificationSha256 !== sha(finalBytes)
    || seal.stageOneCertificationSha256 !== sha(stageOneBytes) || seal.stageTwoCertificationSha256 !== sha(stageTwoBytes)
